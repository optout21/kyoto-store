<div align="center">
  ...
  <p>
    <a href="https://crates.io/crates/bip157-store"><img alt="Crate Info" src="https://img.shields.io/crates/v/bip157-store.svg"/></a>
    <a href="https://github.com/optout21/kyoto-store/blob/master/LICENSE"><img alt="MIT or Apache-2.0 Licensed" src="https://img.shields.io/badge/license-MIT%2FApache--2.0-blue.svg"/></a>
    <a href="https://github.com/optout21/kyoto-store/actions?query=workflow%3A%22Build+%26+Test%22"><img alt="CI Status" src="https://github.com/optout21/kyoto-store/workflows/CI/badge.svg"/></a>
    <a href="https://docs.rs/bip157-store"><img alt="API Docs" src="https://img.shields.io/badge/docs.rs-bip157-store-green"/></a>
...
See the [docs](https://docs.rs/bip157-store) for more details on the `Builder`, `Node`, `Client`, and more.

To add to your project:

```
cargo add bip157-store
```
...
The `bip157-store` core library with default features supports an MSRV of Rust 1.84.
